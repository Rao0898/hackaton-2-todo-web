...
export default function LoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    console.log('Processing...', { email, password });
      ...
      <div className="w-full max-w-md relative z-10">
        <div className="bg-white/5 backdrop-blur-xl rounded-2xl border border-[#F5F5DC]/20 p-8 shadow-xl">
          <div className="text-center mb-8">
            <h1 className="text-3xl font-bold text-[#F5F5DC]">Welcome Back</h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full bg-[#F5F5DC] text-black py-3 px-4 rounded-full font-bold hover:scale-105 transition-transform duration-300 shadow-lg shadow-[#F5F5DC]/20 disabled:opacity-50 disabled:cursor-not-allowed"
            >
